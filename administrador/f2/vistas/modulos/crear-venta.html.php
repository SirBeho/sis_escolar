              ...
              <div class="box">
                ...
                <div class="form-group">
                  ...
                  <div class="input-group">
                    ...
                    <span class="input-group-addon"><button type="button" class="btn btn-default btn-xs" data-toggle="modal" data-target="#modalAgregarCliente" data-dismiss="modal">Agregar Estudiante</button></span>
                ...
                <div class="form-group row nuevoProducto">
                  ...
                  <div class="col-xs-6" style="padding-right:0px">
                    ...
                    <div class="input-group">
                      ...
                      <input type="text" class="form-control" id="agregarProducto" name="agregarProducto" placeholder="Descripción del cobro" required>
                ...
                <button type="button" class="btn btn-default hidden-lg">Agregar cobro</button>
