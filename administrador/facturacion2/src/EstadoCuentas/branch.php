...
?>
        <div id="page-wrapper">
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line">Metodos  
						<?php
...
?>
			...
			<script type="text/javascript" src="js/validation/jquery.validate.min.js"></script>
               ...
               <div class="panel panel-primary">
						...
						<div class="form-group">
								<label class="col-sm-2 control-label" for="Old">Metodos </label>
								<div class="col-sm-10">
		...
		<div class="panel panel-default">
                        <div class="panel-heading">
                            Administrar Información de los Metodos  
                        </div>
                        <div class="panel-body">
    ...
    <div id="footer-sec">
	Sistema De Gestion Escolar--Proyecto Integrador 1 
    </div>
