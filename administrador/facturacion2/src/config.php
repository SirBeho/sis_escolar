...
$sql = mysqli_query($conexion, "SELECT * FROM permisos p INNER JOIN detalle_permisos d ON p.id = d.id_permiso WHERE d.id_usuario = '$id_user'  AND p.nombre = 'configuracion'");
