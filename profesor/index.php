...
<main class="app-content">
      <div class="row">
	    <div class="col-md-12 text-center  border shadow p-2 bg-info text-white">
		    <h3 class="display-4">Sistema Escolar - Area de Docentes</h3>
	  </div>
	  </div>
	  <div class="row">
		...
		<div class="col-md-4 text-center border mt-3 p-4 bg-light">
		    <div class="card m-2 shadow" style="width: 23rem;">
				...
				<div class="card-body">
					...
					<a href="contenido.php?curso=<?= $data['periodo_id'] ?>" class="btn btn-primary">Acceder</a>
					<a href="control_notas/index.php" class="btn btn-warning">Evaluaciones</a>
				</div>
