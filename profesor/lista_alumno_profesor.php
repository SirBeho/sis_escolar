...
<main class="app-content">
      <div class="app-title">
        <div>
          <h1><i class="app-menu__icon fa fa-user-graduate"></i> Lista de Proceso Alumnos
          <button class="btn btn-success" type="button" onclick="openModalAlumnoProfesor()">Nuevo Proceso Alumno</button></h1>
        </div>
