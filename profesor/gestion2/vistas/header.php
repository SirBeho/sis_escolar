        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="../../../administrador/gestion1/files/usuarios/<?php echo $_SESSION['imagen']; ?>" class="user-image" alt="User Image">
              <span class="hidden-xs"><?php echo $_SESSION['nombre']; ?></span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
              <li class="user-header">
                <img src="../../../administrador/gestion1/files/usuarios/<?php echo $_SESSION['imagen']; ?>" class="img-circle" alt="User Image">
...
if ($_SESSION['grupos']==1) {
  echo '<li class="treeview">
        ...
        <li><a href="../../index.php" target="_blanck"><i class="fa  fa-home"></i> <span>Salir</span></a></li>   
