...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 09-08-2022 a las 21:37:58
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `alumno_notas` (IN `p_id_grupo` INT, IN `p_id_alumno` INT)   IF p_id_alumno = 0 THEN
    ...
    join (SELECT * from profesor_materia) p
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `mis_grupos` (IN `p_id_profesor` INT)   IF p_id_profesor = 0 THEN
...
ON pm.profesor_id = p.profesor_id
...
INSERT INTO `alumnos` (`alumno_id`, `nombre_alumno`, `edad`, `direccion`, `cedula`, `clave`, `telefono`, `correo`, `fecha_nac`, `fecha_registro`, `about`, `contact`, `fees`, `branch`, `balance`, `estado`) VALUES
(1, 'Ysaura Vasquez', 15, 'Villa Olga', '12345', '$2y$10$d//If6OfoUqqx1LJWGusEuUrNZyWnSBkGiGTt7WmppUpLi6mH9s9e', 1234, 'A@gmail.com', '2007-01-01', '2022-07-14', 'Excelente estudiante recomendado', '3162345871', 1000000, '2', 700000, b'1'),
(2, 'Fabio Rodriguez', 15, 'V', '1234', '$2y$10$e6yZY0yOU6fDueEFpYGIi.og/H5XdJjOUM3HDMZG7504tXftnrbIG', 1234, 'F@gmail.com', '2007-01-01', '2022-07-14', 'Estudiante es migrado de otro colegio, noticias excelentes.', '3154678143', 1200000, '1', 1080000, b'1'),
(7, 'Juan Fernandez', 15, 'Villa Olga', '45454545', '$2y$10$WICjwK..M2TO3gk1VW5im.kQHzF1D8a1hOmyyk5GUPKMAw/ryU6zW', 8096768989, '1@gmail.com', '2022-07-17', '2022-07-17', 'Realizara pagos en cuotas de 1000', '8099908989', 16000, '7', 15000, b'1'),
(9, 'benjamin', 18, 'Villa olga', '12345678', '$2y$10$VwBWeyhZIfQICbFDD6Gqfuyrf6wkzb80cnX5gZ0V4ZeSsFshPI4hK', 8096768989, '1@gmail.com', '2022-07-19', '2022-07-19', 'Realizara los pagos de 1000', '7878787788', 20000, '7', 10000, b'0'),
(10, 'Juan pablo', 12, 'Villa olga', '123456789', '$2y$10$eeR8pW1iN5ucbt6dH8oD3.qXTAW6dlXOVbxPkuJLwob/sl6glNrke', 8096768989, '1@gmail.com', '2022-07-20', '2022-07-20', 'Primero A', '7878787788', 20000, '7', 19000, b'0'),
(11, 'Liam ', 12, 'Padres las casas', 'liam', '$2y$10$bPWi5eL4Q97zv1rO17Tbm.dOXB.UYM.n/FyKXNwdUR/x4l.PzXT/O', 8096768989567, '1@gmail.com', '2022-07-24', '2022-07-24', 'Primero A', '7878787788', 20000, '7', 19000, b'1'),
(12, 'Radame Rodríguez ', 15, 'Avenidad Estrella sadhala', '010203', '$2y$10$uPMfDLnNOY9FNNJzo5LTDu1yJzx0SZXT0sO0KqhOdjqzRseV7wIL.', 9999999999, '1@gmail.com', '2022-07-27', '2022-07-27', 'Primero A', '7878787788', 20000, '7', 19000, b'1'),
(13, 'benjamin maria', 15, 'josem aria  ', '12458765412', '$2y$10$64ssqB9OO9Hlq.ud9x5gm.jy82xl9MNULFehmU/YjItYz90JfKrp.', 8098862235, 'benjamin@gmail.com', '2022-08-19', '2022-08-09', '', '', 0, '', 0, b'1');
...
INSERT INTO `alumno_profesor` (`ap_id`, `alumno_id`, `id_grupo`, `periodo_id`, `estadop`) VALUES
(1, 2, 1, 4, 1),
(2, 1, 2, 4, 1),
(4, 1, 3, 4, 1),
(5, 2, 3, 4, 1),
...
(10, 'Ramon', 'Villa Olga', 'ramon1', '$2y$10$VKej0WdRWGx1mcsOHHPo8uBRO3Fy.UBJNau1XQYPOwCMKvXED5PxK', 8096768989, '1@gmail.com', 'Profesor de esducacion fisica', 1),
...
(15, 'gior', 'Villa olga', 'gior', '$2y$10$2AOZicZHFF0kjE9b3JHq7OgGCx8Vp6kJI.tEUlZIFZFD3fgXxm.jS', 1, '1@gmail.com', 'Profesor de Historia', 1),
...
INSERT INTO `profesor_materia` (`id_grupo`, `profesor_id`, `grado_id`, `aula_id`, `materia_id`, `periodo_id`, `estadopm`) VALUES
(1, 5, 7, 6, 4, 4, 1),
(2, 6, 7, 7, 4, 4, 1),
(3, 6, 7, 6, 3, 4, 0),
(4, 11, 7, 6, 1, 4, 1),
...
INSERT INTO `usuarios` (`usuario_id`, `nombre`, `usuario`, `clave`, `rol`, `emailid`, `lastlogin`, `estado`) VALUES
(1, 'Luis Noguera', 'admin', '$2y$10$H8pSRwBlnJ5k58hER5DYFuhO6u3eWx58D3D097GuW9AbNdGXAQPHi', 1, 'hola@cweb.com', '0000-00-00 00:00:00', 1),
(2, 'Andres Martinez', 'andres1', '$2y$10$NRNhbzPgwxb8TKqrVqZopu7Pwe.9eJVtK7srAcJWSSAtGXKv03nx.', 1, '13@gmail.com', '2022-07-26 23:35:07', 1),
(3, 'Juan pabloo', 'juan1', '$2y$10$LiKqd3unErTShpSUWd0FueSc2gBBdIJ5CSNOH/XUtQhF3ohaQVSBe', 1, '1444@gmail.com', '2022-07-26 23:35:07', 1),
(4, 'Nachely Rodríguez', 'nachely', '$2y$10$o4z97T7CXO5hfGhAhnS0D.cgI8qIiWYsHRHAdU8uIkyAC8tz8LJnW', 1, 'hol5555a@cweb.com', '0000-00-00 00:00:00', 1),
(5, 'Fabio 21', 'fabio145', '$2y$10$Xb9CT3TFYK7z33mYXLvDZOpbEbFGHCcqR8WNsbAjjf/6UaSwsXRUm', 1, 'hola666@cweb.com', '0000-00-00 00:00:00', 2),
(6, 'Diogenes Núñez', 'Diogenes1', '$2y$10$HYa6YYkQJaBb1L7q/cg8h.j5Jm/p/mO1WizR1xjnCswr3ZkX3KvE6', 2, 'hol7788a@cweb.com', '0000-00-00 00:00:00', 1),
(7, 'Ysaura Vasquez', 'ysaura1', '$2y$10$bRd0cKKByiFzdJa3LQ0uf.j/Q9wGfivNZHiJL7ktUOrAgCBq1d2WG', 1, 'hol7799a@cweb.com', '0000-00-00 00:00:00', 1),
(10, 'Pedro Rodriguez', 'pedro1', '$2y$10$/LnJDSL.HV4OrSsH2jEaV.BGVsDs3avS32zX2eVf9GuWqEUMTkzqq', 2, 'hol7107a@cweb.com', '0000-00-00 00:00:00', 1),
(11, 'Hilari rosio', 'hilari1', '$2y$10$D.lS7CtVEbdM4XGj9.hLVera3i0IpXoOKGUDRat5Mk26aFMa2fXO.', 1, 'hol7711a@cweb.com', '0000-00-00 00:00:00', 1),
(12, 'Dahiana hirata', 'dahi1', '$2y$10$bFAfukJBl9wl2GqbsW6jMO1CgkIIaFCO4ZyIO6h2QaWeWBDu57zvW', 1, 'hol7712a@cweb.com', '0000-00-00 00:00:00', 1),
(13, 'Nayely silveriio', 'nayely1', '$2y$10$kZFt0o/vb/EI2GoqHEoN8eQjmLojb0tLUlqa95TJppI4eRTTy.Pfy', 1, 'hol7137a@cweb.com', '0000-00-00 00:00:00', 2),
(14, 'Cesilio Martinez', 'Cesilio', '$2y$10$vUIgtqnaVyKckRouDuO3KeUgEXytMxNrRgbI0yQForzM2TvP5xM76', 1, 'hol7147a@cweb.com', '0000-00-00 00:00:00', 1),
(15, 'ConfiguroWeb', 'configuroweb', '4b67deeb9aba04a5b54632ad19934f26', 1, 'hola@cweb.com', '0000-00-00 00:00:00', 1),
(16, 'Nachely Rodriguez', 'nachely', '$2y$10$H8pSRwBlnJ5k58hER5DYFuhO6u3eWx58D3D097GuW9AbNdGXAQPHi', 1, '1@gmail.com', '2022-07-26 23:35:07', 1);
...
ALTER TABLE `alumno_profesor`
  ...
  ADD CONSTRAINT `alumno_profesor_ibfk_2` FOREIGN KEY (`id_grupo`) REFERENCES `profesor_materia` (`id_grupo`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Filtros para la tabla `contenidos`
--
ALTER TABLE `contenidos`
  ADD CONSTRAINT `contenidos_ibfk_1` FOREIGN KEY (`id_grupo`) REFERENCES `profesor_materia` (`id_grupo`) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE `notas`
  ...
  ADD CONSTRAINT `notas_ibfk_2` FOREIGN KEY (`id_grupo`) REFERENCES `profesor_materia` (`id_grupo`) ON DELETE CASCADE ON UPDATE CASCADE,
